...
- HTTP calls are another side effects that needs to go in hooks because you interact with the outer world. And then we apply the side effects based on the changes.
- useEffects only returns cleanup functions
