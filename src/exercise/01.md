...
- With the hook the component is rerendered everytime we call the set function, and the value passed again to the useState is the value that we had when we called the set function.
